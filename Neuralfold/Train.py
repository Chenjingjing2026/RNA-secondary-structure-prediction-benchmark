...
class Train:
    ...
    def train(self):
        ...
        for ite in range(self.iters_num):
            ...
            #save model
            serializers.save_npz("/home/chenjingjing/Models/Neuralfold/result/bprna_1m/NEURALfold_params.data" + str(ite), self.model)
            serializers.save_npz("/home/chenjingjing/Models/Neuralfold/result/bprna_1m/NEURALfold_params.data", self.model)
            serializers.save_npz('/home/chenjingjing/Models/Neuralfold/result/bprna_1m/my.state'+ str(ite), self.optimizer)
            serializers.save_npz('/home/chenjingjing/Models/Neuralfold/result/bprna_1m/my.state', self.optimizer)
            ...
            if (self.test_file is not None):
                ...
                file = open('/home/chenjingjing/Models/Neuralfold/result/bprna_1m/bprna_new.txt', 'a')
                result = ['Sensitivity=', str(round(Sensitivity,5)),' ', 'PPV=', str(round(PPV,5)),' ','F_value=', str(round(F_value,5)),' ','MCC=', str(round(MCC,5)),' ',str(self.gamma),'\n']
