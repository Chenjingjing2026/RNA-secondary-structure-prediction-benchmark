...
from evaluation.eval_utils import parse_config, get_data_test, get_model_test, vote4struct, clean_dict, log_eval_metrics, \
    save_metrics
...
def evaluation(args, eval_model, dataloader):
    ...
    with torch.no_grad():
        ...
        for _, batch in enumerate(dataloader):
            ...
            pred_x0, _ = eval_model.sample(batch_size, batch['data_fcn_2'], batch['tokens'], batch['set_max_len'],
                                           contact_masks, batch['data_seq_encode_pad'])
