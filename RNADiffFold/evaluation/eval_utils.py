...
import sys
sys.path.append('/home/chenjingjing/Models/RNA_DiffFold/RNADiffFold/datasets')
# 现在可以正常导入
from data_generator_gt import Dataset, diff_collate_fn
# from datasets.data_generator import Dataset, diff_collate_fn

import sys
sys.path.append('/home/chenjingjing/Models/RNA_DiffFold/RNADiffFold/models')
from model import DiffusionRNA2dPrediction
import collections
...
dataset_choices = ['RNAStrAlign', 'archiveII', 'bpRNA', 'bpRNAnew', 'pdbnew', 'TS_hard','medium']
# DATA_ROOT_PATH = '/home/students/zhyl_fyz/new_dataset/preprocess/'
DATA_ROOT_PATH = '/home/chenjingjing/Models/RNA_DiffFold/RNADiffFold/data/'
