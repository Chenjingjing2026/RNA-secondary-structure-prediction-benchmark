...
from layers import SegmentationUnet2DCondition
from condition.u_conditioner import Unet_conditioner
from condition.fm_conditioner.pretrained import load_model_and_alphabet_local
import lightning.pytorch as pl
import os
CH_FOLD = 1
cond_ckpt_path = os.getcwd()+ '/ckpt/cond_ckpt'
