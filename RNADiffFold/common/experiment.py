...
HOME = '/home/chenjingjing/Models/RNA_DiffFold/RNADiffFold/result/crossfamily_short/tRNA'
...
class BaseExperiment(object):
    ...
    def run(self, epochs):
        for epoch in range(self.current_epoch, epochs):
            ...
            # test
            if (epoch + 1) == epochs or (epoch + 1) % self.test_every == 0:
    ...
    def test(self):
        # HOME = '/home/chenjingjing/Models/RNA_DiffFold/RNADiffFold/result/crossfamily/grp1'
        # ckt_path =HOME+'/logs/rnadifffold/bprna_1m_160_multinomial_diffusion_adam/2025-04-06_18-10-01/check'
        ckt_path = os.path.join(HOME,
                                'logs/rnadifffold/bprna_1m_160_multinomial_diffusion_adam/2025-04-06_18-10-01/check')
        self.checkpoint_load(ckt_path, name='best_checkpoint_1.pt')
        test_dict, f1_pre_rec_df = self.test_fn()
        print(test_dict)
        print(f1_pre_rec_df)
...
class DiffusionExperiment(BaseExperiment):
    ...
    def __init__(self, args,
                 ...
                 model, optimizer, scheduler_iter, scheduler_epoch,current_epoch):
