...
import sys
sys.path.append('/home/chenjingjing/Models/E2Efold')
...
model_path = '/home/chenjingjing/Models/E2Efold/models/bprna_1m/models_ckpt/supervised_{}_{}_d{}_l3_upsampling.pt'.format(model_type, data_type,d)
pp_model_path = '/home/chenjingjing/Models/E2Efold/models/bprna_1m/models_ckpt/lag_pp_{}_{}_{}_position_{}.pt'.format(
...
e2e_model_path = '/home/chenjingjing/Models/E2Efold/models/bprna_1m/models_ckpt/e2e_{}_{}_d{}_{}_{}_position_{}.pt'.format(model_type,
    pp_type,d, data_type, pp_loss,rho_per_position)
...
if data_type=='Rivas':
    train_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'TrainSetA', True)
    val_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'TestSetA')
    # test_data = RNASSDataGenerator('../data/{}/'.format(data_type), 'test_no_redundant')
    test_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'TestSetB')
elif data_type=='RNAStrAlign_ArchiveII':
    train_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'train', True)
    val_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'valid')
    test_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'test')
elif data_type=='bprna_1m':
    train_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'train', True)
    val_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'valid')
    test_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'test')
elif data_type=='bprna_new':
    train_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'bprna_new', True)
    val_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'bprna_new')
    test_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'bprna_new')
...
def per_family_evaluation():
    ...
    pp_exact_p,pp_exact_r,pp_exact_f1, pp_exact_mcc = zip(*result_pp)
    pp_shift_p,pp_shift_r,pp_shift_f1, pp_shift_mcc = zip(*result_pp_shift)
    ...
    print('Average testing MCC with learning post-processing: ', np.average(pp_exact_mcc))
    print('Average testing MCC with learning post-processing allow shift: ', np.average(pp_shift_mcc))

    e2e_result_df = pd.DataFrame()
    e2e_result_df['name'] = [a.name for a in test_data.data]
    # d_type = np.array(list(map(lambda x: x.split('.')[0], name)))  # 按文件名前缀分割
    e2e_result_df['type'] = list(map(lambda x: x.split('.')[0], [a.name for a in test_data.data]))
