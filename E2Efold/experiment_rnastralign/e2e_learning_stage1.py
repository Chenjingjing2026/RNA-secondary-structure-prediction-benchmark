...
model_root = '/home/chenjingjing/Models/E2Efold/models/bprna_1m/models_ckpt/'
if not os.path.exists(model_root):
    os.makedirs(model_root)
model_path = model_root + 'supervised_{}_{}_d{}_l3_upsampling.pt'.format(model_type, data_type,d)
...
if data_type=='Rivas':
    ...
    test_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'test')
# train_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'train', True)
# val_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'val')
# # test_data = RNASSDataGenerator('../data/{}/'.format(data_type), 'test_no_redundant')
# test_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/{}/'.format(data_type), 'test')
...
def model_eval():
    ...
    # print('map_no_train',map_no_train)
...
def model_eval_all_test():
    ...
    nt_shift_p,nt_shift_r,nt_shift_f1, nt_shift_mcc = zip(*result_no_train_shift)
