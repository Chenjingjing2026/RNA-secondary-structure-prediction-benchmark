...
model_path = '../models/RNAStrAlign/supervised_{}_{}_d{}_l3.pt'.format(model_type, data_type,d)
...
# data_path = config.data_path  # 假设config有data_path配置项
# train_data = RNASSDataGenerator(f'{data_path}/{data_type}/', 'train')
# val_data = RNASSDataGenerator(f'{data_path}/{data_type}/', 'val')
# test_data = RNASSDataGenerator(f'{data_path}/{data_type}/', 'test_no_redundant')

train_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/RNAStrAlign/train.pickle', 'train')
val_data = RNASSDataGenerator('/home/chenjingjing/Models/E2Efold/data/RNAStrAlign/valid.pickle', 'val')
test_data = RNASSDataGenerator('/home/chenjingjing/Models/UFold/UFold/data/ArchiveII/ArchiveII.cPickle, 'test_no_redundant')
