...
if Reload:
    ...
    # 使用示例
    check_path = '/home/cjj/RNA_DiffFold/RNADiffFold/result/Rivas/logs/rnadifffold/Rivas_160_multinomial_diffusion_adam/2026-05-14_23-41-03/check'
    name = 'best_checkpoint_8.pt'
    ...
    print(f'Reloading Model , current_epoch : {current_epoch}')
