...
#added
pretrain_modelpath = '/root/lanyun-tmp/LTP/model/512/pretrain_bprna_1m.h5'
train_modelpath = '/root/lanyun-tmp/LTP/model/512/train_bprna_1m.h5'
...
def start_predict(model_name, start_rate, end_rate, seq_list, label_atrix, batch_size):
    ...
    print('constraint_matrix_batch')
    M = constraint_matrix_batch(seq_list)
    print('Start Predict')
    prediction = model.predict((seq_list, M), batch_size=batch_size)
    P, R, f1, cell = val_test(label_atrix, prediction)
    TP = cell[0]
    FP = cell[1]
    TN = cell[2]
    FN = cell[3]
...
Save_dir = '/root/lanyun-tmp/LTP/mydata/bprna_1m/'
