...
from secondary_structure2 import (
    BPseqDataset,
...
# ========== Define constants
TASKS = ["RNAStrAlign", "bpRNA1m","Rivas","Filtered"]
DATASETS = {
    "RNAStrAlign": ("RNAStrAlign_train.lst", "RNAStrAlign_test.lst"),
    "bpRNA1m": ("TR0.lst", "TS0.lst"),
    "Rivas": ("Rivas-A.lst","TestSetB.lst"),
...
parser.add_argument('--model_name_or_path',
                    type=str,
                    default="/root/lanyun-tmp/RNAErnie/output/BERT,ERNIE,MOTIF,PROMPT/checkpoint_final/",
                    help='The build-in pretrained LM or the path to local model parameters.')
parser.add_argument('--model_path',
                    type=str,
                    default="/root/lanyun-tmp/RNAErnie/output/BERT,ERNIE,MOTIF,PROMPT/checkpoint_final/model_state.pdparams",
                    help='The build-in pretrained LM or the path to local model parameters.')
