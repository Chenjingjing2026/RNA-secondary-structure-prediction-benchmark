...
seq_path = '/home/chenjingjing/Models/CDPfold/data/RNAStrAlign/test/seq_data/'
png_path = '/home/chenjingjing/Models/CDPfold/data/RNAStrAlign/test/test_labelpng/'
testset_path = '/home/chenjingjing/Models/CDPfold/data/RNAStrAlign/test/test_set/'
test_one_path = '/home/chenjingjing/Models/CDPfold/data/RNAStrAlign/test/test_one_base/'
if not os.path.exists(test_one_path):
    os.makedirs(test_one_path)
