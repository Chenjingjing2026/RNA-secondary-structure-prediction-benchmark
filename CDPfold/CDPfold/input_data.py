...
def get_batch(image,label,image_W,image_H,batch_size,capacity):
    ...
    #
    # # Define a function to read and preprocess the image
    # def _parse_function(image_path, label):
    #     # Read the image file
    #     image_contents = tf.io.read_file(image_path)
    #     image = tf.image.decode_png(image_contents, channels=3)  # Decode PNG images
    #
    ...
    #
    # # Create an iterator to get batches from the dataset
