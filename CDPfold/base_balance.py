...
if __name__ == "__main__":
    ...
    pathDir = '/home/chenjingjing/Models/CDPfold/data/RNAStrAlign/png/'
    # pathDir2 = '/home/zhangch/Desktop/tmRNA/train_labelpng2/'
    pathDir2 = '/home/chenjingjing/Models/CDPfold/data/RNAStrAlign/png2/'
    if not os.path.exists(pathDir2):
