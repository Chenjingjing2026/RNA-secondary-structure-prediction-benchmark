...
class RNASSDataGenerator(object):
    ...
    def load_data(self, file_pick,Lmax):
        ...
        self.data_name = np.array([instance[0] for instance in self.data],dtype=object)
        self.seq_length= np.array([instance[1] for instance in self.data],dtype=object)
        self.seq_hot= np.array([instance[2] for instance in self.data],dtype=object)
        self.data_y= np.array([instance[3] for instance in self.data],dtype=object)
        self.data_x= np.array([instance[4] for instance in self.data],dtype=object)
        self.data_z= np.array([instance[5] for instance in self.data],dtype=object)
        # print('data_name',self.data_y, self.data_x, self.data_z)
