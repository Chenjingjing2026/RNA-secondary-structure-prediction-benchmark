...
import sys
sys.path.append('/home/chenjingjing/Models/GCNfold/GCNfold-master/GCNfold')
from common.utils import *
from common.config import process_config
...
from RNAGraph import RNADataset, RNADatasetSingle
# from data.RNAGraph import RNADataset, RNADatasetSingle
# from nets.gcnfold_net import GCNFoldNet
import sys
sys.path.append('/home/chenjingjing/Models/GCNfold/GCNfold-master/nets')
from gcnfold_net import GCNFoldNet_UNet
...
def load_test_model(model_type, base_dir, net_params, epoch):
    ...
    PATH = save_dir + model_type + '/model_91' + '.pth'
...
dataset_test = RNADatasetSingle(base_dir, data_type, 'test', config)
